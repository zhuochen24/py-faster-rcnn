...
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_relu1.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_relu2.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_relu3.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_relu4.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_relu5.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_rpn_relu_3x3.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_rpn_cls_score.prototxt
#./experiments/scripts/interp_faster_rcnn_end2end_perlayer_ZF.sh 1 ZF pascal_voc test_all_rpn_bbox_pred.prototxt
